...
// Exercise 19-1: Using String manipulation techniques from 
// Chapter 15, fix Example 19-1 so that if the client sends 
// newline characters, the server removes them before replying 
// back to the client. You will want to alter the "incomingMessage" 
// variable.
